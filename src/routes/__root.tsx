...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "شركة Synth Studio لتطوير البرمجيات والألعاب والذكاء الاصطناعي والأمن السيبراني — تأسست على يد ناصر الحارثي." },
      { name: "author", content: "Nasser Alharthi" },
